...
export default async function ClientLogin({ searchParams }: { searchParams: Promise<{ error?: string; registered?: string }> }) {
        ...
        <div className="legacyLoginPane">
          <div className="legacyLoginCard">
            ...
            <form action="/api/auth/client-login" method="post" className="legacyAuthForm">
              ...
              <div className="legacyAuthLinks"><Link href="#">Forgot Password?</Link><Link href="/client/register">Register Account</Link></div>
